...
def choice(prompt, choices=('y', 'n')):
    ...
    while True:
        ...
        prompt = ("\nSomething is not right. Please ensure you enter a valid option using the correct formatting: \n>")
...
def get_filters():
    ...
    print("To exit the program, at any time, type end.\n")

    while True:
        city = choice("\nWhat city/cities do you want do select data, "
                      "New York City, Chicago or Washington? Use commas "
                      "to seperate the names.\n>", CITY_DATA.keys())
        month = choice("\nFrom January to June, what month(s) do you "
                       "want do filter data? Use commas to seperate the months.\n>",
                       months)
        day = choice("\nWhat weekday(s) do you want do filter bikeshare "
                     "data? Use commas to seperate the days.\n>", weekdays)
...
def load_data(city, month, day):
    ...
    print("\nThe program is loading the data for the chosen filters.")
...
def time_stats(df):
    ...
    print('For the chosen filter, the month with the most travels is: ' +
          str(months[most_common_month-1]).title() + '.')

    # display the most common day of week
    most_common_day = df['Weekday'].mode()[0]
    print('For the chosen filter, the most common day of the week is: ' +
          str(most_common_day) + '.')

    # display the most common start hour
    most_common_hour = df['Start Hour'].mode()[0]
    print('For the chosen filter, the most common start hour is: ' +
...
def station_stats(df):
    ...
    print("For the chosen filters, the most common start station is: " +
          most_common_start_station)

    # display most commonly used end station
    most_common_end_station = str(df['End Station'].mode()[0])
    print("For the chosen filters, the most common end station is: " +
    ...
    most_common_start_end_combination = str(df['Start-End Combination']
                                            .mode()[0])
    print("For the chosen filters, the most common start-end combination "
...
def trip_duration_stats(df):
    ...
    total_travel_time = (str(int(total_travel_time//86400)) +
                         ...
                         str(int(((total_travel_time % 86400) % 3600) % 60)) +
                         's')
    print('For the chosen filters, the total travel time is : ' +
          total_travel_time + '.')
    ...
    print("For the chosen filters, the mean travel time is : " +
          mean_travel_time + ".")
...
def raw_data(df, mark_place):
    ...
    if mark_place > 0:
        last_place = choice("\nWould you like to pick up from where you "
                            "left off? \n [y] Yes\n [n] No\n\n>")
        if last_place == 'n':
            mark_place = 0
    ...
    if mark_place == 0:
        ...
        asc_or_desc = choice("\nWould you like it sorted in ascending or "
                             "descending order? \n [a] Ascending\n [d] Descending"
                             "\n\n>",
                             ('a', 'd'))
...
def main():
    while True:
        ...
        mark_place = 0
        while True:
            select_data = choice("\nPlease choose the information you would "
                                 "like to obtain.\n\n [ts] Time Stats\n [ss] "
